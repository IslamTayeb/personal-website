        ...
        <div className="container px-1 gap-y-0">
          <ul className="exp-slider max-md:mb-4 relative">
            ...
            {experiences.map((experience, index) => (
              <motion.li
                className={`exp-slider-item hover:bg-accent transition-colors max-md:justify-center ${index === selected &&
              ...
              >
                <span
                  className={`font-semibold ${experience.present || experience.incoming ? "mr-2" : ""
                    }`}
                >
                    ...
                    {experiences[selected].shortDescription.map(
                      (description, index) => (
                        <motion.li
                          ...
                          className={`text-sm text-muted-foreground font-sans list-outside list-disc ml-4 ${index !==
