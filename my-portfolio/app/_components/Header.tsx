    ...
    return (
        <header className="sticky top-0 py-4 z-50">
            ...
            <ul className="flex items-center gap-2">                
                <Link href="https://www.researchgate.net/profile/Islam-Tayeb" className={cn(buttonVariants({variant: "outline"}), "size-6 p-0")}>
                    <ResearchGateIcon size={12} className="text-foreground" />
                </Link>

                <Link href="https://linkedin.com/in/islam-tayeb" className={cn(buttonVariants({variant: "outline"}), "size-6 p-0")}>
                    <LinkedInIcon size={12} className="text-foreground" />
                </Link>

                <Link href="https://github.com/IslamTayeb" className={cn(buttonVariants({variant: "outline"}), "size-6 p-0")}>
