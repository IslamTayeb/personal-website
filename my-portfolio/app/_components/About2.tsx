      ...
      <div className="flex max-md:flex-col gap-4">
        <div className="flex flex-col gap-2 flex-1">
          ...
          <p className="text-sm text-muted-foreground font-sans">
            ...
            . I used to be a semi-professional graphic designer in esports for 4
            years, but I still design as a hobby.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2 flex-1">
          ...
          <p className="text-sm text-muted-foreground font-sans">
            I&apos;m a big fan of{' '}
            <Code>
              <DefaultIcon icon="clarity:cd-dvd-solid" /> Alternative Hip Hop
            </Code>
            , and I like to play{' '}
            <Code>
        ...
        <div className="flex flex-col gap-2 flex-1">
          ...
          <p className="text-sm text-muted-foreground font-sans">
            I write opinion articles on{' '}
            <Code>
              <DefaultIcon icon="mdi:newspaper-variant" />{' '}
              <a
                href="https://www.dukechronicle.com/staff/islam-tayeb"
                target="_blank"
                rel="noopener noreferrer"
                className="underline-2"
              >
