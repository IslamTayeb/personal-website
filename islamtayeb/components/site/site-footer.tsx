...
export function SiteFooter() {
  return (
    <footer
      ...
      className="mt-auto grid min-h-[47px] grid-cols-[max-content_minmax(0,1fr)] items-center gap-1 border-t border-border py-2.5 font-mono text-sm leading-normal text-muted-foreground sm:flex sm:justify-between sm:gap-4"
    >
