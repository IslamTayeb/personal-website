...
import type { NetworkEnrichment } from './network-enrichment';
...
export type VisitStorageRecord = {
  eventId: string;
  eventKind: 'pageview';
  clientId: string;
  sessionId: string;
...
export type VisitStorageStatement = {
  text: string;
  values: readonly unknown[];
};

export type VisitStorageQueryResult = {
